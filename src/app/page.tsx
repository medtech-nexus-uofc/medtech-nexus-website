  ...
  return (
    <div className="-my-8 flex flex-col items-center justify-center gap-5 md:gap-10">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-10 lg:mb-10 lg:w-9/10 lg:flex-row xl:mt-10 xl:w-3/4 2xl:w-3/5">
        <div className="bg-bocchi-pink relative my-5 flex h-full w-4/5 flex-col items-center justify-center gap-4 rounded-xl p-4 drop-shadow-md lg:w-2/3 2xl:gap-4">
        ...
        <div className="mb-14 flex w-full flex-col items-center justify-center gap-10 md:mb-16 md:w-4/5 md:flex-row lg:mb-0 lg:w-1/3 lg:flex-col lg:gap-10 xl:mb-0 xl:gap-7">
          <div className="bg-lavender flex h-32 w-4/5 flex-row items-center justify-between rounded-xl px-8 drop-shadow-md md:px-2 lg:px-8">
